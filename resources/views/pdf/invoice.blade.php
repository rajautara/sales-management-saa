        ...
        <tr>
            <td class="header-logo">
                ...
                <div class="company-details">
                    ...
                    @if ($invoice->company->registration_no)
                        Reg No: {{ $invoice->company->registration_no }}<br>
                    @endif
            ...
            <td class="document-title-cell">
                ...
                <div class="document-meta">
                    ...
                    <strong>Date:</strong> {{ $invoice->date->format('Y-m-d') }}<br>
    ...
    <div class="totals-table-container">
        <table class="totals-table">
            ...
            <tr>
                ...
                <td class="val">{{ number_format($invoice->tax, 2) }}</td>
            </tr>
            <tr>
                <td class="label">Discount</td>
                <td class="val">{{ number_format($invoice->discount, 2) }}</td>
            </tr>
            ...
            <tr>
                ...
                <td class="val" style="color: #16a34a;">{{ number_format($invoice->amount_paid, 2) }}</td>
            </tr>
            <tr>
                <td class="label">Amount Due</td>
                <td class="val" style="font-weight: bold; color: #dc2626;">{{ number_format($amountDue, 2) }}</td>
            </tr>
        </table>
    </div>
