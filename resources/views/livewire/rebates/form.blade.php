<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Beri Rebate</h2>
</x-slot>
...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <div class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div>
                <span class="text-gray-500">Max Rebate:</span>
                <span class="font-medium text-gray-900 ml-1">RM {{ number_format($maxRebate, 2) }}</span>
            </div>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="inline-flex items-center px-4 py-2 bg-amber-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Record Rebate
                </button>
            </div>
        </form>
