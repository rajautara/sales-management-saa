    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <div class="flex flex-col md:flex-row justify-between md:items-start gap-4 mb-6">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ $this->getWhatsappUrl('Quotation', $quotation->number, $quotation->customer, (float) $quotation->total, URL::signedRoute('public.quotations.show', $quotation)) }}" target="_blank" class="inline-flex items-center px-3 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150">
